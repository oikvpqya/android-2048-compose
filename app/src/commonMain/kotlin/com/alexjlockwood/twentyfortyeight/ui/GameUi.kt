...
fun GameUi(
    ...
    NavigationEventHandler(
        ...
        isBackEnabled = uiState is GameUiState.Success && uiState.isUndoable,
        onBackCompleted = {
            ...
            modifier = Modifier
                ...
                .pointerInput(Unit) {
                    ...
                    detectDragGestures(
                        ...
                        onDragEnd = {
                            val direction = when (swipeAngle) {
                                in 45.0 ..< 135.0 -> Direction.NORTH
                                in 135.0 ..< 225.0 -> Direction.WEST
                                in 225.0 ..< 315.0 -> Direction.SOUTH
                                else -> Direction.EAST
                            }
